const ErrorMappingFal1 = {
  B2: {
    order: 'a',
    'field required': "You must select either 'arrival in the UK' or 'departure from the UK'",
  },
  B3: { // name of ship
    order: 'b',
    'field required': 'You must enter the name of the ship',
  ...
  D3: { // IMO number
    order: 'c',
    'field required': 'Enter the IMO number',
    'Enter 7 numbers for the IMO number': 'Enter 7 numbers for the IMO number',
  },
  F3: { // callsign
    order: 'd',
    'field required': 'Enter the call sign',
  ...
  B4: { // signatory / master o ship
    order: 'e',
    'field required': 'Enter the name of master or authorised officer on board',
  ...
  D4: { // flagstate
    order: 'f',
    'field required': 'Enter the 3-letter code for the flag state or the country where the vessel is usually based',
  ...
  B5: { // arrival port
    order: 'g',
    'field required': 'Enter a LOCODE for the arrival port',
  ...
  D5: {
    order: 'h',
    'field required': 'Enter a date of arrival',
  },
  F5: {
    order: 'i',
    'field required': 'Enter an arrival time',
  },
  B6: { // departure port
    order: 'j',
    'field required': 'Enter a LOCODE for the departure port',
    'Enter a LOCODE that contains 5 letters, for example NL RTM or NLRTM. If no LOCODE exists for the location, enter NOXXX': 'Enter a LOCODE that contains 5 letters, for example NL RTM or NLRTM. If no LOCODE exists for the location, enter the country code and then XXX',
  ...
  D6: {
    order: 'k',
    'field required': 'Enter a date of departure',
  },
  F6: {
    order: 'l',
    'field required': 'Enter a departure time',
  },
  D7: { // previous port
    order: 'm',
    'field required': 'Enter a last port of call LOCODE',
    'Enter a LOCODE that contains 5 letters, for example NL RTM or NLRTM. If no LOCODE exists for the location, enter NOXXX': 'Enter a LOCODE that contains 5 letters, for example NL RTM or NLRTM. If no LOCODE exists for the location, enter the country code and then XXX',
  ...
  F7: { // next port
    order: 'n',
    'field required': 'Enter a next port of call LOCODE',
    'Enter a LOCODE that contains 5 letters, for example NL RTM or NLRTM. If no LOCODE exists for the location, enter NOXXX': 'Enter a LOCODE that contains 5 letters, for example NL RTM or NLRTM. If no LOCODE exists for the location, enter the country code and then XXX',
  ...
  B13: { // cargo
    order: 'o',
    'field required': "Enter a brief description of the cargo, or put 'No cargo'",
