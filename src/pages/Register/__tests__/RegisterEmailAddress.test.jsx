...
describe('Register email address tests', () => {
  ...
  it('should display a primary styled continue button', () => {
    render(<MemoryRouter><RegisterEmailAddress /></MemoryRouter>);
    expect((screen.getByTestId('submit-button')).outerHTML).toEqual('<button type="submit" class="govuk-button" data-module="govuk-button" data-testid="submit-button">Send confirmation email</button>');
  });
