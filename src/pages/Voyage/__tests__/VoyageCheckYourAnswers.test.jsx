...
describe('Voyage task list page', () => {
  ...
  it('should render the list titles on the page', () => {
    ...
    // expect(screen.getByText('Crew details').outerHTML).toEqual('<dt class="govuk-summary-list__key">Crew details</dt>');
    // expect(screen.getByText('Passenger details').outerHTML).toEqual('<dt class="govuk-summary-list__key">Passenger details</dt>');
    // expect(screen.getByText('Supporting documents').outerHTML).toEqual('<dt class="govuk-summary-list__key">Supporting documents</dt>');
  });
  ...
  //   const user = userEvent.setup();
  //   render(<MemoryRouter><VoyageCheckYourAnswers /></MemoryRouter>);
  //   expect(screen.getByTestId('changeCrewLink')).toBeInTheDocument();
  //   await user.click(screen.getByTestId('changeCrewLink'));
  //   await waitFor(() => {
  ...
  //   const user = userEvent.setup();
  //   render(<MemoryRouter><VoyageCheckYourAnswers /></MemoryRouter>);
  //   expect(screen.getByTestId('changePassengerLink')).toBeInTheDocument();
  //   await user.click(screen.getByTestId('changePassengerLink'));
  //   await waitFor(() => {
  ...
  //   const user = userEvent.setup();
  //   render(<MemoryRouter><VoyageCheckYourAnswers /></MemoryRouter>);
  //   expect(screen.getByTestId('changeSupportingDocumentsLink')).toBeInTheDocument();
  //   await user.click(screen.getByTestId('changeSupportingDocumentsLink'));
  //   await waitFor(() => {
